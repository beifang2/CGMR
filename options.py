...
def args_parser():
    ...
    args_algo_rounds_iters.add_argument('--rounds', type=int, default=10,
    ...
    args_algo.add_argument('--num_clients', '-K', type=int, default=10,
                        help="number of clients")
    args_algo.add_argument('--num_classes', type=int, default=20,
                        help="number of classes")
    args_algo.add_argument('--pool_size', type=int, default=30,
                        help="number of pool")
    args_algo.add_argument('--mode', type=str, default='hsi',
                        help="mode")
    args_algo.add_argument('--useatten', type=bool, default=True,
                        help="use attention")
    ...
    args_algo.add_argument('--epochs', '-E', type=int, default=1,
    ...
    args_algo.add_argument('--usepro', type=bool, default=True,
                        help="use prototypes")
    args_algo.add_argument('--dataset', type=str, default="fix_R1_szutree_split_noniid_alpha0.3_add0_1000",
                        help="dataset")
    args_algo.add_argument('--dataset_val', type=str, default="TS_image_0.7_1024_alpha0.3_test_miss",
                        help="dataset_val")
    ...
    args_algo.add_argument('--lambda2', type=float, default=0.01,
                        help="lambda2")
    args_algo.add_argument('--algorithm', type=str, default="CGMR",
                           help="algorithm")
    ...
    args_model_optim_sched.add_argument('--optim_args', type=str, default='lr=0.002,momentum=0,weight_decay=4e-4',
    ...
    args_output.add_argument('--name', type=str, default='test',
